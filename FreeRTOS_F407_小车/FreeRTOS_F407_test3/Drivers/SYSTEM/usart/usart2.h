...
#define USART2_TX_GPIO_PIN               GPIO_PIN_10						//橙色
#define USART2_TX_GPIO_AF                GPIO_AF7_USART3
#define USART2_TX_GPIO_CLK_ENABLE()      do{ __HAL_RCC_GPIOB_CLK_ENABLE(); }while(0)   /* 发送引脚时钟使能 */

#define USART2_RX_GPIO_PORT              GPIOB
#define USART2_RX_GPIO_PIN               GPIO_PIN_11						//黄色
#define USART2_RX_GPIO_AF                GPIO_AF7_USART3
#define USART2_RX_GPIO_CLK_ENABLE()      do{ __HAL_RCC_GPIOB_CLK_ENABLE(); }while(0)   /* 接收引脚时钟使能 */

#define USART2_UX                        USART3
#define USART2_UX_IRQn                   USART3_IRQn
#define USART2_UX_IRQHandler             USART3_IRQHandler
#define USART2_UX_CLK_ENABLE()           do{ __HAL_RCC_USART3_CLK_ENABLE(); }while(0)  /* USART1 时钟使能 */
